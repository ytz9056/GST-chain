...
struct integration_test : public gstio::contract {
      ...
      typedef gstio::multi_index<N(payloads), payload> payloads;
      ...
      void store( account_name from,
         ...
         gstio_assert( num < std::numeric_limits<size_t>::max(), "num to large");
...
GSTIO_ABI( integration_test, (store) )
