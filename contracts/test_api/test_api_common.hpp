...
#ifdef DISABLE_GSTLIB_SERIALIZE
#include <gstiolib/serialize.hpp>
#undef GSTLIB_SERIALIZE
#define GSTLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  GSTLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   GSTLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   GSTLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   GSTLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
