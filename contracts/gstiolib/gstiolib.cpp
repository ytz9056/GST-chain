...
namespace gstio {
   ...
   void get_blockchain_parameters(gstio::blockchain_parameters& params) {
      ...
      gstio_assert( size <= sizeof(buf), "buffer is too small" );
   ...
   private:
      ...
      public:
         ...
         {
            gstio_assert(_offset == _heap_size, "malloc_from_freed was designed to only be called after _heap was completely allocated");
