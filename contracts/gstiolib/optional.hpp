   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { gstio_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { gstio_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            gstio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return gstio::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline gstio::datastream<Stream>& operator>> (gstio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline gstio::datastream<Stream>& operator<< (gstio::datastream<Stream>& ds, const optional& op)
         {
