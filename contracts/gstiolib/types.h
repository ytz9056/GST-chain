 ...
 * @details GSTIO Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
 ...
 * @details GSTIO Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of GSTIO Transaction Id
 * @details Type of GSTIO Transaction Id. It is 256-bit hash
 */
