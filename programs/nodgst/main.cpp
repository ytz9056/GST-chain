...
int main(int argc, char** argv)
{
   try {
      ...
      ilog("gstio root is ${root}", ("root", root.string()));
      ilog("nodgst using configuration file ${c}", ("c", app().full_config_file_path().string()));
      ilog("nodgst data directory is ${d}", ("d", app().data_dir().string()));
      app().startup();
      app().exec();
