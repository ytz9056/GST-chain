/**
 *  @file
 *  @copyright defined in gstio/LICENSE.txt
 */
...
void blocklog::read_log() {
   ...
   GST_ASSERT( end, block_log_exception, "No blocks found in block log" );
   GST_ASSERT( end->block_num() > 1, block_log_exception, "Only one block found in block log" );
...
int main(int argc, char** argv)
{
   ...
   options_description cli ("gstio-blocklog command line options");
   try {
      blocklog blog;
