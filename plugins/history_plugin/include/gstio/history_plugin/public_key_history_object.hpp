...
CHAINBASE_SET_INDEX_TYPE( gstio::public_key_history_object, gstio::public_key_history_multi_index )

FC_REFLECT( gstio::public_key_history_object, (public_key)(name)(permission) )
