...
CHAINBASE_SET_INDEX_TYPE( gstio::account_control_history_object, gstio::account_control_history_multi_index )

FC_REFLECT( gstio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
