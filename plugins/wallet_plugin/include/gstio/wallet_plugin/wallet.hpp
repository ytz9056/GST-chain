...
class soft_wallet final : public wallet_api
{
   public:
       ...
       *
       * example: remove_key GST6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
       *
...
FC_REFLECT( gstio::wallet::wallet_data, (cipher_keys) )

FC_REFLECT( gstio::wallet::plain_keys, (checksum)(keys) )
