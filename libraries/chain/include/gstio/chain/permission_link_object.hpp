...
CHAINBASE_SET_INDEX_TYPE(gstio::chain::permission_link_object, gstio::chain::permission_link_index)

FC_REFLECT(gstio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
