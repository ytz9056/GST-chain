...
#include <gstio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(gstio::chain::table_id_object, gstio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(gstio::chain::key_value_object, gstio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(gstio::chain::index64_object, gstio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(gstio::chain::index128_object, gstio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(gstio::chain::index256_object, gstio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(gstio::chain::index_double_object, gstio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(gstio::chain::index_long_double_object, gstio::chain::index_long_double_index)

FC_REFLECT(gstio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(gstio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(gstio::chain::index64_object)
REFLECT_SECONDARY(gstio::chain::index128_object)
REFLECT_SECONDARY(gstio::chain::index256_object)
REFLECT_SECONDARY(gstio::chain::index_double_object)
REFLECT_SECONDARY(gstio::chain::index_long_double_object)
