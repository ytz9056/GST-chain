...
CHAINBASE_SET_INDEX_TYPE(gstio::chain::transaction_object, gstio::chain::transaction_multi_index)

FC_REFLECT(gstio::chain::transaction_object, (expiration)(trx_id))
