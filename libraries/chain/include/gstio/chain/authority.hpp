...
FC_REFLECT(gstio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(gstio::chain::key_weight, (key)(weight) )
FC_REFLECT(gstio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(gstio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(gstio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
