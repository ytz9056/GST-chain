...
CHAINBASE_SET_INDEX_TYPE(gstio::chain::permission_object, gstio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(gstio::chain::permission_usage_object, gstio::chain::permission_usage_index)

FC_REFLECT(gstio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(gstio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(gstio::chain::permission_usage_object, (last_used))
