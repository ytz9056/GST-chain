...
namespace gstio { namespace chain {
    ...
    *  In the context of gstio, every action is dispatched to the handler defined
...
FC_REFLECT( gstio::chain::permission_level, (actor)(permission) )
FC_REFLECT( gstio::chain::action, (account)(name)(authorization)(data) )
