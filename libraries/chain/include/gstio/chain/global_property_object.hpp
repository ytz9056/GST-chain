...
#include <gstio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(gstio::chain::global_property_object, gstio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(gstio::chain::dynamic_global_property_object,
                         gstio::chain::dynamic_global_property_multi_index)

FC_REFLECT(gstio::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(gstio::chain::global_property_object,
