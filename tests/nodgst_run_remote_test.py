...
###############################################################
# nodgst_run_remote_test
#  Tests remote capability of the nodgst_run_test. Test will setup cluster and pass nodes info to nodgst_run_test. E.g.
#  nodgst_run_remote_test.py -v --clean-run --dump-error-detail
###############################################################
...
pnodes=1
total_nodes=pnodes
actualTest="tests/nodgst_run_test.py"
...
try:
    ...
    Print("Starting up %s test: %s" % ("nodgst", actualTest))
    Print("cmd: %s\n" % (cmd))
